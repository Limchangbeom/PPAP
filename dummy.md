...
#### 1. 동적 IP 주소의 개인정보성 확립: Breyer 판결 (Case C-582/14)
...
#### 2. 익명화와 가명화의 경계: Nowak 판결 (Case C-434/16)
...
#### 1. 쿠키 배너와 사전 체크박스의 위법성: Planet49 판결 (Case C-673/17)
...
#### 2. 동의의 자유로움과 조건부 서비스(Cookiewalls) 관련: Orange España 판결 (Case C-61/19 등) 및 EDPB 지침
...
#### 1. 공동 컨트롤러 책임 범위: Fashion ID 판결 (Case C-40/17)
...
#### 2. 위탁 계약 미체결 및 수탁자 관리 소홀에 대한 과징금 부과례 (EDPB 주요 집행 사례)
...
#### 1. 미국 간의 데이터 이전 체계 무효화: Schrems I & II 판결
...
## 5. 미성년자 대상 개인정보 수집 (GDPR 제8조 및 각국 연령 기준)
...
2. **예외 사유 (제2항):** 1. 계약의 체결이나 이행을 위해 필수적인 경우, ② EU 또는 회원국 법률에 명시적 근거가 있고 적절한 보호 조치가 마련된 경우, ③ 정보주체의 명시적 동의(Explicit consent)를 받은 경우에는 예외적으로 허용됩니다.
3. **정보주체 보호 장치 (제3항):** 예외 사유로 인해 자동화된 처리가 이루어지는 경우라도, 컨트롤러는 최소한 **1. 담당자의 개입을 요구할 권리, 2. 자신의 의견을 표명할 권리, 3. 결정에 대해 이의를 제기(Contest)할 권리**를 포함한 적절한 안전장치를 보장해야 합니다.
...
#### 1. 신용평가사(Scoring)의 자동화 결정 해당성: SCHUFA 판결 (Case C-634/21)
...
#### 1. 쿠키 동의의 유효성 요건: Planet49 판결 (Case C-673/17)
...
| No | 핵심 판단 질문 | PIPA 근거 | GDPR 근거 |
| --- | --- | --- | --- |
| CⅠ-1 | 대상 정보가 살아있는 개인에 관한 정보이며, 단독 또는 다른 정보와 결합하여 특정 개인을 알아볼 수 있는가? | 제2조제1호 | 제4조제1항 |
| CⅠ-2 | 결합 가능성 판단 시 입수 가능성, 시간, 비용, 기술 및 합리적 수단을 종합적으로 고려했는가? | 제2조제1호나목 | 고려사항 제26항 |
| CⅠ-3 | IP·쿠키·기기식별자 등 온라인 식별자를 개인 식별이 가능한 정보로 관리하고 있는가? | 법문 해석 적용 | 제4조제1항·고려사항 제30항 |
| CⅠ-4 | 가명정보는 개인정보로 취급하여 보호조치를 적용하고, 재식별 불가능한 익명정보만 적용 제외하는가? | 제2조제1호다목·제3조제7항 | 제4조제5항·고려사항 제26항 |
| CⅠ-5 | 민감정보 및 고유식별정보 처리 시 일반 개인정보와 구분된 별도 강화 절차를 거치는가? | 시행령 제18조·제19조 | 제9조제1항 |

#### 2. 수집·이용 및 동의 (공통 6항목)

| No | 핵심 판단 질문 | PIPA 근거 | GDPR 근거 |
| --- | --- | --- | --- |
| CⅡ-1 | 동의, 계약 이행, 법률상 의무 등 처리 목적에 알맞은 적법 처리 근거(Lawful Basis)를 확보했는가? | 제15조제1항 | 제6조제1항 |
| CⅡ-2 | 동의 수집 시 강요 없이 자유로운 의사에 기반하며, 명확한 적극적 행위(Opt-in)로 받았는가? | 시행령 제17조 | 제4조제11항·제7조제4항 |
| CⅡ-3 | 목적·항목·보유기간 등 필수 고지사항을 알기 쉬운 문구로 명확히 안내하고 동의를 얻었는가? | 제15조제2항·시행령 제17조 | 제7조제2항·제13조 |
| CⅡ-4 | 처리 목적이 복수이거나 제공·홍보 등 사유가 다를 경우 목적별로 구분하여 각각 동의를 받았는가? | 제22조제1항 | 제7조제2항·고려사항 제32항 |
| CⅡ-5 | 선택 정보 미동의를 이유로 필수 재화·서비스 제공을 거부하지 않는가? | 제16조제3항·제22조제5항 | 제7조제4항 |
| CⅡ-6 | 정보주체의 동의 철회권을 보장하며, 동의 및 철회 사실을 입증할 수 있도록 기록 관리하는가? | 제16조제1항·제37조 | 제7조제1항·제7조제3항 |

#### 3. 제3자 제공·위탁·국외이전 (공통 6항목)

| No | 핵심 판단 질문 | PIPA 근거 | GDPR 근거 |
| --- | --- | --- | --- |
| CⅢ-1 | 외부 이전 시 받는 자의 독자적 목적 유무에 따라 제공과 위탁의 성격을 정확히 구분했는가? | 제17조 vs 제26조 | 제4조제7항·제8항 |
| CⅢ-2 | 제3자 제공 시 법적 근거를 확보하고, 필수 고지사항(수령인, 목적, 항목, 기간 등)을 제공 동의 시 안내했는가? | 제17조제1항·제2항 | 제6조제1항·제13조제1항 |
| CⅢ-3 | 목적 외 이용·제공 시 별도 동의/법률 등 예외 요건 및 본래 목적과의 양립성(Compatibility)을 검토했는가? | 제15조제3항·제18조 | 제5조제1항·제6조제4항 |
| CⅢ-4 | 수탁자와의 위탁 계약을 문서(계약서)로 체결하고, 위탁 업무 내용과 수탁자를 공개 및 통지했는가? | 제26조제1항·제2항 | 제28조제3항·제13조제1항 |
| CⅢ-5 | 수탁자에 대한 관리·감독 및 교육을 실시하고, 재위탁 시 사전 승인/동의 절차를 거치는가? | 제26조제4항·제6항 | 제28조제1항·제4항 |
| CⅢ-6 | 국외 이전 시 해당 국가의 적법 허용 사유(동의, 적정성 결정, 표준계약조항 등)를 충족하고 보호조치를 이행하는가? | 제28조의8제1항 | 제44조~제49조 |

#### 4. PIPA 전용 기준 (국내 특화 5항목)

| No | 핵심 판단 질문 | PIPA 근거 | GDPR 대응 방식 |
| --- | --- | --- | --- |
| P-1 | 주민등록번호 처리를 원칙적 금지하고, 법령 근거가 있는 경우에만 암호화 등 안전조치를 적용하여 처리하는가? | 제24조의2 | 해당 없음 (일반 개인정보로 규율) |
| P-2 | 민감정보 및 고유식별정보 수집 시 다른 일반 개인정보 처리 동의와 "별도로" 동의를 받았는가? | 제23조제1항·제24조제1항 | 제9조제2항 (명시적 동의로 대응) |
| P-3 | 동의 없이 처리하는 정보의 항목·근거를 처리방침에 동의 기반 정보와 명확히 구분하여 공개/통지했는가? | 제22조제3항·제30조 | 제13조 (투명성 의무로 포괄) |
| P-4 | 만 14세 미만 아동의 개인정보 처리 시 법정대리인 동의 및 동의 여부 확인 절차를 거치는가? | 제22조의2 | 제8조 (정보사회서비스 16세/13세 기준) |
| P-5 | 홍보·판매권유 위탁 시 개별 통지, 영업양도·합병 시 사전·사후 통지 절차를 준수하는가? | 제26조제3항·제27조 | 제5조제1항 (목적 제한 원칙 적용) |

#### 5. GDPR 전용 기준 (EU 특화 6항목)

| No | 핵심 판단 질문 | GDPR 근거 | PIPA 대응 방식 |
| --- | --- | --- | --- |
| G-1 | 민감범주(인종, 정치, 종교, 유전·생체 등) 처리 시 엄격한 **명시적 동의(Explicit Consent)**를 확보했는가? | 제9조제2항제(a)호 | 제23조제1항 (별도 동의 제도로 대응) |
| G-2 | 동의 철회 절차가 동의를 주는 것만큼 쉽고 간편하게 제공되는가? | 제7조제3항 | 제37조 (철회권 규정 존재하나 용이성 명문은 없음) |
| G-3 | 위탁 계약 시 GDPR 제28조제3항이 요구하는 9가지 필수 의무사항(문서화된 지시, 비밀유지 등)이 모두 반영되었는가? | 제28조제3항 | 제26조·시행령 제28조 (5개 표준항목 규정) |
| G-4 | 수탁자의 재위탁(Sub-processor)에 대해 '사전 서면 승인(구체적 또는 일반적)'을 받는 구조인가? | 제28조제4항 | 제26조제6항 (위탁자 동의 규정) |
| G-5 | 국외 이전 시 **[①적정성 결정 → ②적절한 보호장치(SCC/BCR) → ③예외 사유]**의 법적 위계를 준수하는가? | 제44조~제49조 | 제28조의8 (5개 사유 대등하게 열거) |
| G-6 | 국외 이전 예외 동의 수집 시 적정성 인정/보호장치 부재에 따른 **'특유의 위험성'**을 명확히 고지했는가? | 제49조제1항제(a)호 | 제28조의8제2항 (고지 5개 항목 규정) |
